    ...
    <div class="background-img">
        <div>
            <div class=" background-text">
                <h1 class="">Explore World With Trip Planner</h1>
                ...
                <div class=" col-md-11  image-form-div"
                    ...
                    <form action="showdirection.php" method="post" target="_blank" class="form-inline image-form">
                        <div class="form-group">
                            <input type="text" name="fromCity" id="from_city" class="form-control "
                                placeholder="Your Location">
                        </div>
                        <div class="form-group">
                            <input type="text" name="toCity" id="to_city" class="form-control "
                ...
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-map-marker fa-4x"
                                aria-hidden="true" style="margin: 20px 35px"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-calendar-check-o fa-4x"
                                aria-hidden="true" style="margin: 20px 23px"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="col-md-12">
                        <div class="circle col-md-offset-2 circle-logo "><i class="fa fa-suitcase fa-4x"
                                aria-hidden="true" style="margin: 20px 21px"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="shuffle-group">
                    <div data-si-mousemove-trigger="100" class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">Visit the world longest sea beach</h2>
                        </a>
                        <div class="images">
                    ...
                    <div class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">A district of green beauty</h2>
                        </a>
                        <div class="images">
                    ...
                    <div class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info"> an emerging tourist spot in Bangladesh</h2>
                        </a>
                        <div class="images">
                ...
                <div class="shuffle-group">
                    <div data-si-mousemove-trigger="100" class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">one of the largest such forests in the world </h2>
                        </a>
                        <div class="images">
                    ...
                    <div class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">Its a full of beautiful historic mosques</h2>
                        </a>
                        <div class="images">
                ...
                <div class="shuffle-group">
                    ...
                    <div class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">Dhaka is the capital city of Bangladesh</h2>
                        </a>
                        <div class="images">
                    ...
                    <div class="shuffle-me">
                        <a href="#" class="info a_info" target="_blank">
                            ...
                            <h2 class=" h1_info">Famous for its panoramic sea beach.</h2>
                        </a>
                        <div class="images">
